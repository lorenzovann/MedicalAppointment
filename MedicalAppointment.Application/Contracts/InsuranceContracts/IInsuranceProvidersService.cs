...
{
    public interface IInsuranceProvidersService : IBaseService<InsuranceProvidersResponse,InsuranceProvidersGetDto, InsuranceProvidersUpdateDto, InsuranceProvidersUpdateDto>
    {
